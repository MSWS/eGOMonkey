...
function handleForumsList() {
    ...
    fetch("https://www.edgegamers.com/forums/685/").then(function (response) {
        response.text().then(function (text) {
            ...
            let userHref = thread.querySelector('.structItem-cell--latest > .structItem-minor > a');
            ...
            let icon = thread.querySelector('.structItem-cell--icon.structItem-cell--iconEnd > .structItem-iconContainer > a');
